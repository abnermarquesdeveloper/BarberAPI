...
//rota para a criação rondomica de barbeiros para facilitar.
//Route::get('/random', [BarberController::class, 'createRandom']);

Route::get('/user', [UserController::class, 'read']);
Route::put('/user', [UserController::class, 'update']);
Route::get('/user/favorites', [UserController::class, 'getFavorites']);
Route::post('/user/favorite', [UserController::class, 'addToggleFavorite']);
...
Route::post('/barber/{id}/appointment', [BarberController::class, 'setAppointmnet']);
